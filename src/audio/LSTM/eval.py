...
add_arg('configs',          str,   'src/audio/bi_lstm.yml',    "配置文件")
add_arg("use_gpu",          bool,  False,                     "是否使用GPU评估模型")
add_arg('save_matrix_path', str,   'output/audio',         "保存混合矩阵的路径")
add_arg('resume_model',     str,   'output/audio\model\BidirectionalLSTM_CustomFeatures/best_model',  "模型的路径")
